<?php
/**
 * ISSimple_Pages class.
 *
 * Pages adapted to IS Simple.
 *
 * @package WordPress
 ...
 * @since IS Simple 1.0
 */
class ISSimple_Pages extends WP_Widget {
...
/**
 * Register the IS Simple Pages Widget.
 *
 * @return void
 */
function issimple_pages_widget() {
	register_widget( 'ISSimple_Pages' );
}

add_action( 'widgets_init', 'issimple_pages_widget' );
