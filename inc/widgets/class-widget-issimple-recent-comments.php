<?php
/**
 * ISSimple_Recent_Comments class.
 *
 * Recent comments adapted to IS Simple.
 *
 * @package WordPress
 ...
 * @since IS Simple 1.0
 */
class ISSimple_Recent_Comments extends WP_Widget {
...
/**
 * Register the IS Simple Recent Comments Widget.
 *
 * @return void
 */
function issimple_recent_comments_widget() {
	register_widget( 'ISSimple_Recent_Comments' );
}

add_action( 'widgets_init', 'issimple_recent_comments_widget' );
